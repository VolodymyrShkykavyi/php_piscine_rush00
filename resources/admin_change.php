...
if (isset($_POST['add_artName']) && isset($_POST['add_artCat']) && isset($_POST['add_artUrl']) && isset($_POST['add_artDescr']) && isset($_POST['add_artPrice']) && isset($_POST['add_artSku']) && $_POST['submit'] == "Add article") {
	$arr = create_product_arr($_POST['add_artName'], $_POST['add_artCat'], $_POST['add_artUrl'], $_POST['add_artDescr'], $_POST['add_artPrice'], $_POST['add_artSku']);
	add_product($arr);
}
